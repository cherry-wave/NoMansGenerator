...
public class PatternSaveDialog extends DialogFragment {
    ...
    public static PatternSaveDialog newInstance(Pattern pattern) {
        PatternSaveDialog patternSaveDialog = new PatternSaveDialog();
